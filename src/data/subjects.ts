...
export const subjectData = {
  Computing: {
    'Computing and Information Systems': {
      ...
      'Semester 2': [
        { code: 'CIS2101', name: 'Object Oriented Programming', credits: 3 },
        {
          code: 'CIS2102',
          name: 'Object Oriented Programming Practicum',
          credits: 3,
        },
        { code: 'CIS2103', name: 'Emerging IS Technologies', credits: 3 },
        { code: 'CIS2104', name: 'Database Systems', credits: 3 },
        {
          code: 'CIS2105',
          name: 'Database Management Systems Practicum',
          credits: 3,
        },
        { code: 'CIS2106', name: 'System Analysis & Design', credits: 3 },
        { code: 'CIS2107', name: 'Social & Professional Issues', credits: 3 },
        { code: 'CIS2108', name: 'Human Computer Interaction', credits: 3 },
        {
          code: 'CIS2109',
        ...
        { code: 'CIS21011', name: 'Advanced Mathematics', credits: 3 },
      ],
    },
